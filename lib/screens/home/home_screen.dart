              ...
              if (state is HomeLoading) {
                      ...
                      BlocBuilder<AuthBloc, AuthState>(
                        builder: (context, authState) {
                          ...
                          if (authState is AuthAuthenticated) {
                            ...
                            name = authState.user.displayName?.split(' ').first ?? 'User';
                          }
                          return Text(
                            'Hi, $name',
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(width: 4, height: 4, decoration: const BoxDecoration(color: AppColors.iconGrey, shape: BoxShape.circle)),
                    const SizedBox(width: 4),
                    Container(width: 4, height: 4, decoration: const BoxDecoration(color: AppColors.iconGrey, shape: BoxShape.circle)),
                  ],
                ),
